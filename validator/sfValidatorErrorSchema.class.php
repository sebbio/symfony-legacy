<?php
  ...
  class sfValidatorErrorSchema extends sfValidatorError implements ArrayAccess, Iterator, Countable {
    ...
    public function __unserialize ($serialized) {
      $this->validator = $serialized[0];
      $this->arguments = $serialized[1];
      $this->code = $serialized[2];
      $this->message = $serialized[3];
      $this->errors = $serialized[4];
      $this->globalErrors = $serialized[5];
      $this->namedErrors = $serialized[6];
    }
