...
//    return preg_replace('/\-(.)/e', "'-'.strtoupper('\\1')", strtr(ucfirst(strtolower($name)), '_', '-'));
    ...
    public function __unserialize ($serialized) {
        $this->content = $serialized[0];
        $this->statusCode = $serialized[1];
        $this->statusText = $serialized[2];
        $this->options = $serialized[3];
        $this->headerOnly = $serialized[4];
        $this->headers = $serialized[5];
        $this->metas = $serialized[6];
        $this->httpMetas = $serialized[7];
        $this->stylesheets = $serialized[8];
        $this->javascripts = $serialized[9];
        $this->slots = $serialized[10];
    }
